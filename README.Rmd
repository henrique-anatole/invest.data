...
`invest.funks` is a lightweight R package that provides convenient wrappers to fetch and prepare financial time series data from **Yahoo Finance, Tiingo, and Binance**.
...
You can install the development version of **invest.funks** from GitHub with:
